...
const WORDS = ["Manual Testing Specialist",
  "Playwright Automation Engineer",
  "API Testing Enthusiast",
  "Quality Assurance Professional"];
const TECH_STACK = ["Postman", "Cucumber", "Playwright", "Selenium", "Jira"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Viveka-123" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/chitakula-viveka/" },
  { icon: Instagram, link: "https://www.instagram.com/silence_in_the_nature/" },
];
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Passionate about delivering reliable, user-friendly software through
