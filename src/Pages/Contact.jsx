  ...
  return (
    ...
    >
      <div className="text-center mb-12" data-aos="fade-up" data-aos-duration="1000">
        <h2
          className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7] mb-4"
        >
          Contact Me
        </h2>
        <p
          className="text-slate-300 text-sm sm:text-base md:text-lg max-w-3xl mx-auto font-light leading-relaxed"
        >
          Got a question? Let's Connect and Build Quality Together.
        </p>
      </div>

      <div className="container mx-auto flex items-center justify-center px-[5%] md:px-0">
